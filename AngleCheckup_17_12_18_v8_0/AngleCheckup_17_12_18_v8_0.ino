...
void loop()
{
	...
	aver_first_inter_time = float(time_delta_first) / first_inter_count;  // время прохода угла в 90 градусов
	...
	aver_second_inter_time = float(time_delta_second) / second_inter_count;
